  ...
  translations: {
    ...
    Certificates: {
      ...
      certificateThree: {
        ...
        contentOne: 'Introdução à SQL, funções SQL e JOINs',
        contentTwo: 'Normalização e Modelagem de Banco de Dados',
        contentThree: 'Introdução a MongoDB',
        contentFour: 'MongoDB - Upadates simples e complexo',
        contentFive: 'MongoDB - Aggregation Framework',
        contentSix: 'Desenvolvimento Web com NodeJs',
        contentSeven: 'NodeJs - Arquitetura MSC, Rest e Restful ',
        contentEight: 'Autenticação e Upload de arquivos',
        contentNine: 'Deployment',
        contentTen: 'Arquitetura SOLID e ORM',
