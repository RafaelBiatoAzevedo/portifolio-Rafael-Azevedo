const objExport = {
  translations: {
    ...
    HardSkills: {
      ...
      hsNine: 'Vue',
      hsTen: 'React',
      hsEleven: 'React Native',
      hsTwelve: 'Redux',
      hsThirteen: 'Context API',
      hsFourteen: 'NodeJS',
      hsFifteen: 'Express JS',
      hsSixteen: 'MongoDB',
      hsSeventeen: 'MySql',
      hsEightteen: 'Git',
      hsNineteen: 'GitHub',
    ...
    Projects: {
      view: 'Visit WebSite',
      title: 'Projects in the course of TRYBE',
      titleOne: 'Type',
      titleTwo: 'Status',
      titleThree: 'Data',
    ...
    Certificates: {
      ...
      certificateThree: {
        ...
        contentOne: 'Introduction to SQL, functions SQL and JOINs',
        contentTwo: 'Database Standardization and Modeling',
        contentThree: 'Introduction to MongoDB',
        contentFour: 'MongoDB - Simple and Complex Upgrades',
        contentFive: 'MongoDB - Aggregation Framework',
        contentSix: 'Web Development with NodeJs',
        contentSeven: 'NodeJs - Architecture MSC, Rest and Restful ',
        contentEight: 'Authentication and Upload of files',
        contentNine: 'Deployment',
        contentTen: 'Architecture SOLID and ORM',
        contentEleven: 'Sockets',
      },
      certificateFour: {
